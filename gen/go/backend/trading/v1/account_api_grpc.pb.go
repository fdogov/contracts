...
const (
	AccountService_GetAccount_FullMethodName          = "/backend.trading.v1.AccountService/GetAccount"
	AccountService_GetAccountsByUserId_FullMethodName = "/backend.trading.v1.AccountService/GetAccountsByUserId"
)
...
func (c *accountServiceClient) GetAccountsByUserId(ctx context.Context, in *GetAccountsByUserIdRequest, opts ...grpc.CallOption) (*GetAccountsByUserIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountService_GetAccountsByUserId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "backend.trading.v1.AccountService",
	...
	Metadata: "backend/trading/v1/account_api.proto",
}
